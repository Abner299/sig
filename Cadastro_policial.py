...
def add_criminal_registry():
    ...
    if result:
        nome = result[0]
        num_registro = input("Digite o nome da vitima: ")#18/08/2023, passsa a ser vitima.
...
while True:
    ...
    print('\033[40;1;37m''\033[31m' +"1 - Adicionar registro Criminal \033[0m") 
    print('\033[40;1;37m''\033[31m' +"2 - Adicionar Boletim de ocorrencia \033[0m") 
    print("3 - Retornar ao Banco de dados ")
