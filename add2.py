...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS registros_criminais (
        ...
        cpf TEXT,
        incidencia TEXT,
        FOREIGN KEY (cpf) REFERENCES registros_civis (cpf)
    )
''')
...
while True:
    ...
    print("1 - Adicionar registro civil") 
    print("2 - Adicionar registro criminal") 
    print("3 - Adicionar registro veicular")
    print("4 - Retornar ao Banco de dados")
